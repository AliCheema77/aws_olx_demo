...
from products.api.v1.viewsets import CategoryViewSet, SubCategoryViewSet, PostImageViewSet, CarPostViewSet,\
    ...
    VehicleFilterView, PropertyForSaleFilterView, CategoryFilterView, SearchPostByTitleView, ExpiredAdView
...
urlpatterns = [
    ...
    path("expired_ad/", ExpiredAdView.as_view(), name="expired_ad"),
]
